...
parser.add_argument("-i",
                    "-input_file",
                    type=str,
                    help="Filepath to experiment description file where each row has 4 columns, condition_id, replicate_id, filename, and area_filename")
...
parser.add_argument("-g",
                    "--get_uniprot",
                    help="Required internet connection. Enable parsing of UniProt ID from protein name and request the original protein name from the UniProt databas.",
                    action="store_true")
